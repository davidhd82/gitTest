...
class WebBuilder {
    ...
    generateCSS(selectedPage, colorTheme) {
        return `/* Styles for ${(selectedPage === undefined) ? ("") : selectedPage.page_name} */ ${(selectedPage === undefined) ? ("") : selectedPage.css_content.replace(/#333/g, colorTheme)}`;
    }
    generateHTML(selectedPage) {
        return `/* HTML for ${(selectedPage === undefined) ? ("") : selectedPage.page_name} */ ${(selectedPage === undefined) ? ("") : selectedPage.html_content}`;
    }
    generateJS(selectedPage) {
        return `/* JS for ${(selectedPage === undefined) ? ("") : selectedPage.page_name} */ ${(selectedPage === undefined) ? ("") : selectedPage.js_content}`;
    }
